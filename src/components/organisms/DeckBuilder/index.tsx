  ...
  return (
    <Box position="relative" h="calc(100vh - 0px)">
      ...
      <Grid
        ...
        mx="auto"
      >
        {/* Card Browser, My Decks, or Deck Cards */}
        <Box overflow="auto" p="1rem">
          {showMyDecks ? (
            ...
            <VStack gap={4} alignItems="stretch">
              ...
              {(!currentDeck.avatar && (!currentDeck.spellbook || currentDeck.spellbook.length === 0) && (!currentDeck.atlas || currentDeck.atlas.length === 0)) ? (
                <Box textAlign="center" py="4rem">
                  <p className={css({ color: 'gray.400', fontSize: '1.25rem' })}>
          ...
          {!showMyDecks && !showDeckCards && filteredCards.length > 100 && (
            <p
              className={css({
                color: "gray.400",
                textAlign: "center",
